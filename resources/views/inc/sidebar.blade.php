    <div class="col-sm-4 col-lg-3 col-xl-2">
        <nav class="vh-80">
            <div class="text-center mb-5">
                ...
                @else
                    <img src="{{ asset('img/default.png') }}" class="rounded-circle mr-1" height="50%" width="50%" />
                @endif
            </div>
            <ul class="nav-list list-group px-3">
                ...
                <li class="list-item my-2 {{ Request::is('admin/profile') ? 'active' : '' }}">
                    <a href="{{ route('admin.profile') }}" class="btn my-btn btn-block"><span
                            class="fas fa-home mr-4"></span>Profile</a>
                </li>
                <li class="list-item my-2">
                    <a href="#" class="btn my-btn btn-block"><span class="fas fa-home mr-4"></span>Settings</a>
                </li>
            </ul>
            ...
            <ul class="nav-list list-group mt-5 px-3">
                ...
                <li class="list-item my-2">
                    <a href="#" class="btn my-btn btn-block"><span class="fas fa-home mr-4"></span>Users</a>
                </li>
                <li class="list-item my-2">
                    <a href="#" class="btn my-btn btn-block"><span class="fas fa-home mr-4"></span>Categories</a>
                </li>
                <li class="list-item my-2">
                    <a href="#" class="btn my-btn btn-block"><span class="fas fa-home mr-4"></span>Authors</a>
                </li>
                <li class="list-item my-2">
                    <a href="#" class="btn my-btn btn-block"><span class="fas fa-home mr-4"></span>Publishers</a>
                </li>
            </ul>
        </nav>
    </div>
