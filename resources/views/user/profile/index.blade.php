                        ...
                        <main class="card rounded">
                            ...
                            <div class="card-body vh-100">
                                ...
                                <section class="posts">
                                    ...
                                    --}}
                                    <div class="d-flex">
                                        <button class="btn w-100 btn-link border-right border-top">Reviews</button>
                                        <button class="btn w-100 btn-link border-top">Blogs</button>
                                    </div>

                                    <div class="border-bottom border-top mt-5 py-4">
                                        <div class="d-flex justify-content-between align-items-center px-4">
                                            <h5>Blog posts</h5>
                                            <a href="{{ route('user.blogs.create') }}" class="btn my-btn my-btn-outline">New Blog</a>
                                        </div>
